...
#                                                                                          #
# Fit the model referred to as Model B, as proposed in the present paper, based in         #
# Jiang, Y., Tan, Q., Wen, W., Wang, D., Cai, Y., & Tu, D. (2025). A family of cognitive   #
# diagnosis models for continuous bounded responses. Journal of Educational and            #  
# Behavioral Statistics, 50(3), 526-564.                                                   #
#                                                                                          #
# Data are available in                                                                    #
# https://github.com/tobywise/covid19-risk-perception/blob/master/data/all_data_wide.csv   #      
#                                                                                          #
# Codes and Q matrix are described in the Supplemental Materials in the online             #
# version of Jiang et al (2025)                                                            #                              
#                                                                                          #
# Code Author:                                                                             #                                                             
############################################################################################
...
para <- c("pai","m0", "n0", "m1", "n1","loglik","ppp")
...
jagsfit <- jags.parallel(data, inits=NULL, para, "BDINABetamodelBDIC.txt",  n.chains=2, 
                         n.iter = 5000, 
...
write.csv(results[1:nrow(results),],"ResultsBDINAModelBApp2.csv")
...
#### Saving Rdata
save.image("FitBDINAModelBApp2.RData")
