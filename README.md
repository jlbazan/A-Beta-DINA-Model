...
Jorge L. Bazán, Eduardo S. B. de Oliveira, Xiaojing Wang and Jimmy de la Torre (2026). Modeling in Jags: A Beta DINA model. Version v1.0. URL: https://github.com/jlbazan/A-Beta-DINA-Model.
...
title = {Modeling in Jags: A Beta DINA model},  <br>
year = {2026},  <br>
version = {v1.0},
